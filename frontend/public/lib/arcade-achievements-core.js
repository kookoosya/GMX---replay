(function (global) {
  if (global.GMXArcadeAchievementsCore) return;

  const ACHIEVEMENT_DEFS = [
    { id: "first_launch", icon: "🎮", titleKey: "arcade_ach_first_title", descKey: "arcade_ach_first_desc" },
    { id: "explorer", icon: "🧭", titleKey: "arcade_ach_explorer_title", descKey: "arcade_ach_explorer_desc" },
    { id: "arcade_fan", icon: "🔥", titleKey: "arcade_ach_fan_title", descKey: "arcade_ach_fan_desc" },
    { id: "gotd_player", icon: "⭐", titleKey: "arcade_ach_gotd_title", descKey: "arcade_ach_gotd_desc" },
    { id: "category_hopper", icon: "🎯", titleKey: "arcade_ach_category_title", descKey: "arcade_ach_category_desc" },
    { id: "pro_title", icon: "👑", titleKey: "arcade_ach_pro_title", descKey: "arcade_ach_pro_desc" },
  ];
  ...
  function normalizeProgress(raw) {
    ...
    const cleanGotd = Array.from(new Set(gotdDays.map((x) => String(x || "").trim()).filter(Boolean)));
  ...
  function recordPlay(progress, game, meta) {
    meta = meta || {};
    const p = normalizeProgress(progress);
    ...
    if (!existing) {
      p.played.push({
        id,
        category: String((game && (game.category || game.categoryKey)) || "").trim(),
        access: String((game && game.access) || "free").trim() || "free",
        at: now,
      });
    }
  ...
  global.GMXArcadeAchievementsCore = {
    ACHIEVEMENT_DEFS,
    todayKey,
    emptyProgress,
    normalizeProgress,
