...
export async function startAppShell() {
  ...
  window.__GMX_APP_SHELL_BOOT_PROMISE = (async () => {
    ...
    await injectAppShellRuntime("/app.adminrunwire.js", "gmx-legacy-adminrunwire");
    ...
    await injectAppShellRuntime("/app.leaderboardrunwire.js", "gmx-legacy-leaderboardrunwire");
    ...
    await injectAppShellRuntime("/app.referralsrunwire.js", "gmx-legacy-referralsrunwire");
    ...
    await injectAppShellRuntime("/app.redeemrunwire.js", "gmx-legacy-redeemrunwire");
    ...
    await injectAppShellRuntime("/app.predictionrunwire.js", "gmx-legacy-predictionrunwire");
    ...
    await injectAppShellRuntime("/app.connectrunwire.js", "gmx-legacy-connectrunwire");
    ...
    await injectAppShellRuntime("/app.walletrunwire.js", "gmx-legacy-walletrunwire");
