...
test("pwa cache policy keeps thumbnails cacheable but not full wallpapers", () => {
  assert.equal(isWallpaperFullAssetPath("/assets/wallpapers/sitev5_001.webp"), true);
  assert.equal(isWallpaperFullAssetPath("/assets/wallpapers/thumbs/sitev5_001.webp"), false);
  assert.equal(isWallpaperFullAssetPath("/assets/extskins/extskin_v5_001.webp"), true);
  assert.equal(isWallpaperFullAssetPath("/assets/extskins/thumbs/extskin_v5_001.webp"), false);
  assert.equal(isSwCacheableAssetPath("/assets/wallpapers/sitev5_001.webp"), false);
  assert.equal(isSwCacheableAssetPath("/assets/wallpapers/thumbs/sitev5_001.webp"), true);
});
