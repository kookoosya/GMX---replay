...
test("wallpapers: catalog and url helpers", () => {
  ...
  assert.match(wp.wallpaperFullUrl("v2_001", site), /\/assets\/wallpapers\/livev1_001\.webp\?v=rev1$/);
  assert.match(wp.wallpaperThumbUrl("v2_001", site), /\/assets\/wallpapers\/thumbs\/livev1_001\.webp\?v=rev1$/);
