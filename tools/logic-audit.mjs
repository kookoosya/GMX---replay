...
for (const rel of htmlFiles) {
  ...
  mustMatch(rel, /app\.adminrunwire\.js/, "app.adminrunwire.js script tag");
  ...
  mustMatch(rel, /app\.leaderboardrunwire\.js/, "app.leaderboardrunwire.js script tag");
  ...
  mustMatch(rel, /app\.referralsrunwire\.js/, "app.referralsrunwire.js script tag");
  mustMatch(rel, /app\.redeem\.js/, "app.redeem.js script tag");
  mustMatch(rel, /app\.redeemwire\.js/, "app.redeemwire.js script tag");
  mustMatch(rel, /app\.redeemrunwire\.js/, "app.redeemrunwire.js script tag");
  ...
  mustMatch(rel, /app\.connectrunwire\.js/, "app.connectrunwire.js script tag");
  ...
  mustMatch(rel, /app\.walletrunwire\.js/, "app.walletrunwire.js script tag");
  mustMatch(rel, /app\.bestpick\.js/, "app.bestpick.js script tag");
  mustMatch(rel, /app\.refstats\.js/, "app.refstats.js script tag");
  mustMatch(rel, /app\.generateflow\.js/, "app.generateflow.js script tag");
  mustMatch(rel, /app\.generatewire\.js/, "app.generatewire.js script tag");
