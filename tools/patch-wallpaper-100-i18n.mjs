#!/usr/bin/env node
/** Patch i18n for 100 wallpapers and 13 categories across all locales. */
...
const THEMES_DESC = {
  en: "Choose from 100 curated photographic wallpapers below. Accent colors follow your saved theme preset. Referrals and Pro expand what you can pick; Pro adds custom uploads.",
  de: "Wählen Sie aus 100 kuratierten Fotohintergründen unten. Akzentfarben folgen Ihrem gespeicherten Theme. Referrals und Pro erweitern die Auswahl; Pro ermöglicht eigene Uploads.",
  fr: "Choisissez parmi 100 fonds d'écran photo ci-dessous. Les couleurs d'accent suivent votre thème enregistré. Parrainages et Pro élargissent le choix ; Pro ajoute vos propres fichiers.",
  es: "Elige entre 100 fondos fotográficos curados abajo. Los colores de acento siguen tu tema guardado. Referidos y Pro amplían la selección; Pro añade cargas propias.",
  pt: "Escolha entre 100 papéis de parede fotográficos abaixo. As cores de destaque seguem o tema salvo. Indicações e Pro ampliam a escolha; Pro adiciona uploads próprios.",
  it: "Scegli tra 100 sfondi fotografici curati qui sotto. I colori d'accento seguono il tema salvato. Referral e Pro ampliano la scelta; Pro aggiunge caricamenti personali.",
  nl: "Kies uit 100 gecureerde fotowallpapers hieronder. Accentkleuren volgen je opgeslagen thema. Referrals en Pro vergroten de keuze; Pro voegt eigen uploads toe.",
  tr: "Aşağıdan 100 seçilmiş fotoğraf duvar kağıdı arasından seçin. Vurgu renkleri kayıtlı temanızı izler. Referanslar ve Pro seçimi genişletir; Pro özel yüklemeler ekler.",
  pl: "Wybierz spośród 100 starannie dobranych fototapet poniżej. Kolory akcentu podążają za zapisanym motywem. Polecenia i Pro rozszerzają wybór; Pro dodaje własne pliki.",
  id: "Pilih dari 100 wallpaper foto kurasi di bawah. Warna aksen mengikuti tema tersimpan. Referral dan Pro memperluas pilihan; Pro menambah unggahan sendiri.",
  ru: "100 курируемых фотографических обоев — выбирайте ниже. Акцентные цвета следуют сохранённой теме. Рефералы и Pro открывают больше; Pro добавляет свои загрузки.",
  uk: "100 кураторських фото-шпалер — обирайте нижче. Акцентні кольори слідують збереженій темі. Реферали та Pro розширюють вибір; Pro додає власні завантаження.",
  hi: "नीचे 100 क्यूरेटेड फोटो वॉलपेपर में से चुनें। एक्सेंट रंग आपकी सहेजी थीम का अनुसरण करते हैं। रेफरल और Pro विकल्प बढ़ाते हैं; Pro कस्टम अपलोड जोड़ता है।",
  ja: "下から100枚の厳選フォト壁紙を選べます。アクセント色は保存したテーマに従います。紹介とProで選択肢が広がり、Proは独自アップロードを追加します。",
  zh: "从下方100张精选摄影壁纸中选择。强调色跟随您保存的主题。推荐与Pro扩展可选范围；Pro可添加自定义上传。",
};

const EN_ONLY = {
  wp_cat_neon_city: "Neon city",
...
for (const file of fs.readdirSync(localesDir).filter((f) => f.endsWith(".json"))) {
  ...
  if (lang === "en") {
    j.themes_desc = THEMES_DESC.en;
    Object.assign(j, EN_ONLY);
  } else {
    if (THEMES_DESC[lang]) j.themes_desc = THEMES_DESC[lang];
...
console.log("patch-wallpaper-100-i18n: ok");
