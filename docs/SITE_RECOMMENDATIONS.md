...
### UX
- [x] **Хлебные крошки** — «Home > GM» при глубокой навигации
- [x] **Сохранение вкладки** — при возврате на сайт открывать последнюю вкладку (`gmx_last_tab`)
- [x] **Skeleton loaders** — при загрузке списков (GM, GN, Arcade)
