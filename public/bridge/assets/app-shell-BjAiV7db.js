import{r,j as l}from"./react-vendor-CiqHrYgP.js";import{S as u}from"./i18n-catalog-Fhk1rlOC.js";import"./vendor-DYLXRpC5.js";const g=`<div aria-hidden="true" class="bg"></div>
<div class="wrap">
<header>
<div class="brand">
...
`;function o(n,i){return new Promise((e,d)=>{try{const t=document.getElementById(i);if(t){if(t.__gmxReady===!0){e();return}t.addEventListener("load",()=>e(),{once:!0}),t.addEventListener("error",()=>d(new Error(`Failed to load ${n}`)),{once:!0});return}const s=document.createElement("script");s.id=i,s.src=n,s.async=!0,s.onload=()=>{try{s.__gmxReady=!0}catch{}e()},s.onerror=()=>d(new Error(`Failed to load ${n}`)),document.body.appendChild(s)}catch(t){d(t instanceof Error?t:new Error(String(t||"app shell runtime inject failed")))}})}async function h(n=12e3){const i=Date.now();for(;Date.now()-i<n;){try{if(typeof window.__gmxShowTab=="function")return}catch{}await new Promise(e=>window.setTimeout(e,50))}throw new Error("App shell runtime did not expose __gmxShowTab in time")}async function y(){if(!window.__GMX_APP_SHELL_STARTED){if(window.__GMX_APP_SHELL_BOOT_PROMISE)return window.__GMX_APP_SHELL_BOOT_PROMISE;window.__GMX_APP_SHELL_BOOT_PROMISE=(async()=>{await o("/mode.js","gmx-legacy-mode"),await o("/entitlements.js","gmx-legacy-entitlements"),await o("/app.auth.js","gmx-legacy-auth"),await o("/app.js","gmx-app-shell-runtime"),await h(),window.__GMX_APP_SHELL_STARTED=!0})();try{await window.__GMX_APP_SHELL_BOOT_PROMISE}finally{window.__GMX_APP_SHELL_BOOT_PROMISE=void 0}}}function c(n,i){try{if(document.getElementById(i))return;const e=document.createElement("script");e.id=i,e.src=n,e.async=!0,document.head.appendChild(e)}catch{}}const _=new Set(["home","gm","gn","referrals","leaderboard","themes","extthemes","wallet","admin"]);function w(){try{const n=String(localStorage.getItem("gmx_last_tab")||"").trim();return _.has(n)?n:"home"}catch{return"home"}}function f(n){const i=(n||"/").replace(/\/$/,"")||"/",e=i.replace(/^\/app(?=\/|$)/,"")||"/";return e==="/gm"?"gm":e==="/gn"?"gn":e==="/referrals"?"referrals":e==="/leaderboard"?"leaderboard":e==="/themes"?"themes":e==="/extension-themes"||e==="/extthemes"?"extthemes":e==="/upgrade"||e==="/wallet"?"wallet":e==="/admin"?"admin":i==="/"||i==="/app"||i.startsWith("/app/")?w():"home"}function P(){const[n,i]=r.useState("booting"),[e,d]=r.useState("");return r.useEffect(()=>{const t="http://127.0.0.1:10000".trim(),s=String(window.location.hostname||"").toLowerCase(),v=s==="127.0.0.1"||s==="localhost",m=/^https?:\/\/(?:localhost|127\.0\.0\.1):10000$/i.test(t);window.__GMX_API_ORIGIN=v&&m?"":t,c("https://cdn.jsdelivr.net/npm/@solana/web3.js@1.95.8/lib/index.iife.min.js","solana-web3-iife"),c("/mode.js","gmx-mode-js");try{window.GMX_SITE_I18N={createSiteI18nCatalog:()=>u}}catch{}c("/entitlements.js","gmx-entitlements-js");const b=window.setTimeout(async()=>{var p;try{window.__GMX_APP_SHELL_HTML_OK=!0,await y();try{const a=f(window.location.pathname);(p=window.__gmxShowTab)==null||p.call(window,a)}catch{}i("ready")}catch(a){console.error("[GMX App Shell] boot failed:",a),d(String((a==null?void 0:a.stack)||(a==null?void 0:a.message)||a)),i("error")}},0);return()=>window.clearTimeout(b)},[]),l.jsxs(l.Fragment,{children:[n==="error"&&l.jsxs("div",{style:{position:"fixed",top:8,left:8,zIndex:99999,padding:"8px 10px",borderRadius:10,fontSize:12,background:"rgba(0,0,0,.72)",color:"#fff",maxWidth:520,lineHeight:1.35,border:"1px solid rgba(255,255,255,.12)"},children:[l.jsx("div",{style:{fontWeight:700,marginBottom:4},children:"GMXReply UI"}),l.jsx("div",{style:{color:"#ffb4b4"},children:"Boot failed"}),l.jsx("pre",{style:{margin:"6px 0 0",whiteSpace:"pre-wrap"},children:e})]}),l.jsx("div",{id:"gmx-app-shell-root",dangerouslySetInnerHTML:{__html:g}})]})}export{P as default};
